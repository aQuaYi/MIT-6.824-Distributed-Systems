...
or by passing messages on channels, perhaps to a central goroutine
that manages state changes. For Raft, we recommend shared data
...
drive the periodic checks; time.Ticker and Time.Timer are difficult to
use correctly.
